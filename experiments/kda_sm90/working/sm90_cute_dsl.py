    ...
    class KdaPrepareFwdSm90:
        ...
        def kernel(
            ...
            if i >= j and tg_i < T and tg_j < T:
                # Keep this as a device loop until the BF16 tensor-core
                # dot-product path below replaces it. Fully expanding all 128
                # iterations in the CuTe frontend creates an enormous MLIR
                # module and makes this specialization impractical to compile.
                for d in range(DIM):
